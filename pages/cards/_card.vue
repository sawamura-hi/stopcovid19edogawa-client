<template>
  <div>
    ...
    <telephone-advisory-reports-number-card
      ...
      "
    />
    <telephone-advisory-reports-number-card-custom
      v-else-if="
        this.$route.params.card ==
          'number-of-reports-to-covid19-telephone-advisory-center-custom'
      "
    />
...
import TelephoneAdvisoryReportsNumberCardCustom from '@/components/cards/TelephoneAdvisoryReportsNumberCardCustom.vue'
...
export default {
  components: {
    ...
    TelephoneAdvisoryReportsNumberCardCustom,
